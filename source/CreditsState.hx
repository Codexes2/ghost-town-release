	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [
			...
			[
				'Aqwa',
				'aqwa',
				'Director/Sprite Artist/Writer',
				'https://twitter.com/aqwwa58',
				'11D985'
			],
			['Tressa', 'tressa', 'BG Artist', 'https://twitter.com/TressaNightmaus', '7A3539'],
			['Xiang', 'lam', 'UI Artist', 'https://twitter.com/x2xiang', 'FFFFFF'],
			[
				'The Striking Zebra',
				'zebra',
				'Writer',
				'https://twitter.com/striking_zebra',
				'BC00FF'
			],
			['ASARI', 'asari', 'Musician', 'https://twitter.com/Asari0206_', 'FFCB40'],
			['Auric', 'auric', 'Musician', 'https://twitter.com/Auricross', 'FF2E36'],
			['GGalactigal', 'haruka', 'Musician', 'https://twitter.com/GGalactigal', 'DD1D45'],
			['Awoofle', 'awoo', 'Programmer', 'https://twitter.com/Awoofle', 'F479AC'],
			['Codexes', 'codexes', 'Programmer', 'https://twitter.com/Codexes1', 'FF692E'],
			[
				'Gabe',
				'gabe',
				'Charter',
				'https://www.youtube.com/channel/UC_zlcBMPZspzShwA12QGIjw',
				'28B429'
			],
			[
				'Grand Hammer 6',
