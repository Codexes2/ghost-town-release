...
class DialogueBoxPsych extends FlxSpriteGroup
{
	...
	public function new(dialogueList:DialogueFile, ?song:String = null)
	{
		...
		{
			case 'till-when':
				touhouBG = new FlxSprite(0, 0);
				touhouBG.loadGraphic(Paths.image('dialogue/unknown', 'ghost'));
				touhouBG.screenCenter(XY);
				touhouBG.setGraphicSize(1280, 720);
				touhouBG.alpha = 1;
			case 'ultimate-truth':
				touhouBG = new FlxSprite(0, 0);
				touhouBG.loadGraphic(Paths.image('stage1', 'ghost'));
				touhouBG.screenCenter(XY);
				touhouBG.setGraphicSize(1280, 720);
				touhouBG.alpha = 1;
			case 'ghost-lead':
				touhouBG = new FlxSprite(0, 0);
				touhouBG.loadGraphic(Paths.image('stage2', 'ghost'));
				touhouBG.screenCenter(XY);
				touhouBG.setGraphicSize(1280, 720);
				touhouBG.alpha = 1;
		}
